...
/**
 * Formats tool execution records accumulated across rounds for inclusion in
 * Planner/Executor prompts (used on resume so the LLM sees what was already done).
 */
public final class ExecutionRecordFormatter {

    private ExecutionRecordFormatter() {}

    public static String formatPreviousExecutionRecords(TaskExecutionState state) {
